...
const MoviePage = () => {
  ...
  const [url, setUrl] = useState(
    "https://api.themoviedb.org/3/movie/popular?api_key=2927b407ca91bdfbbb8c799b04291de6"
  );
  ...
  useEffect(() => {
    if (filterDebounce) {
      setUrl(
        `https://api.themoviedb.org/3/search/movie?api_key=2927b407ca91bdfbbb8c799b04291de6&query=${filterDebounce}`
      );
    } else {
      setUrl(
        "https://api.themoviedb.org/3/movie/popular?api_key=2927b407ca91bdfbbb8c799b04291de6"
